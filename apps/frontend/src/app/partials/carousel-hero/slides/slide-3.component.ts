...
@Component({
  selector: 'app-slide-3',
  standalone: true,
  template: `
    <div class="flex justify-center h-full p-6 bg-gray-300 dark:bg-gray-800 dark:text-gray-100">
      <div class="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
        ...
        <div class="flex items-center justify-center p-6 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
          <img src="assets/images/1.jpeg" alt="" class="object-contain h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
        </div>
      </div>
    </div>
